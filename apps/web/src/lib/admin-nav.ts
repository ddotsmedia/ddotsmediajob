...
/**
 * The admin sidebar's routes — the single source for both the sidebar and the
 * Cmd+K palette. Kept here rather than in the layout so the palette cannot end
 * up offering a destination the sidebar doesn't have (or one that 404s).
 */
