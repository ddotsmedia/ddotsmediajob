...
type Props = { title: string; url: string; company: string };
...
export function SocialShareBar({ title, url, company }: Props) {
  const [copied, setCopied] = useState(false);
  const waText = `🔔 Job: ${title} at ${company} – Apply here: ${url}`;
