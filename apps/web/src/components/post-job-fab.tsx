...
export function PostJobFab() {
  ...
  return (
    <Link
      ...
      className="fixed right-4 z-40 inline-flex items-center gap-2 rounded-full bg-teal-600 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-teal-600/30 hover:bg-teal-700 active:scale-95 md:hidden"
    >
